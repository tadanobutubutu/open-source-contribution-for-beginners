...
public class MainActivity extends AppCompatActivity implements CategoriesRVAdapter.CategoryClicked{
    ...
    public void getNews(String category){
        ...
        String categoryUrl = "https://newsapi.org/v2/top-headlines?country=in&category"+ category + "&apiKey=***REMOVED***";
        String Url = "http://newsapi.org/v2/top-headlines?country=in&excludeDomains=stackoverflow.com&sortBy=publishedAt&language=en&apiKey=***REMOVED***";
